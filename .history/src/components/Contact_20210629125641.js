         ...
         <div className="contacts">
             ...
             <div>
                 <ul>
                     ...
                     <li>01877774030, 01877774031, 01877774033, 01877774013, 01877774005</li>
                     <li>01877774020, 01877774021, 01795205080, 01733336433, 01764100000</li>
                 </ul>
             </div>
         </div>
         <div className="links">
             ...
             <div className="social">
                 <a href="https://www.facebook.com/ugvbarisal">facebook.com/ugvbarisal</a>
             </div>
         </div>
    </div>;
  }
